...
<main class="snap-container">
    <section class="hero snap-item">
        <div class="container hero-text">
            <h2>Re-Imagine your Home as a World Class Restaurant</h2>
        </div>
    </section>

    <section id="about" class="section-light section-padding snap-item">
        <div class="container">
            <h3>Hello!</h3>
    ...
    <section id="tasting-menus" class="section-dark section-padding snap-item">
        <div class="container">
    ...
    <section class="section-light section-padding snap-item">
